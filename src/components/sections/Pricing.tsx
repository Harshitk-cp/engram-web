...
const tiers = [
  ...
  },
  {
    ...
    price: "$499",
    priceSub: "per month",
    description: "Scale to heavy production workloads — high limits and full observability across your agents.",
    cta: { label: "Get started", href: `${CONSOLE_URL}/signup?plan=growth`, external: false },
    features: [
      "Everything in Team",
      "100 agents",
